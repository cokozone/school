...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="{{ asset('backend/css/images/favicon.ico')}}">

    <title>CoKoZoNe - Log in </title>
					...
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">เข้าไม่ได้อ่ะดิ ? <a href={{ route('register') }} class="text-info ml-5">ลงทะเบียนก่</a></p>
							</div>
						</div>
					</div>
				</div>
